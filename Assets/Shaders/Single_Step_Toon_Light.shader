Shader "Custom/Single_Step_Toon_Light"
{
	Properties
	{
		...
		CGPROGRAM
			...
			float4 LightingStepped(SurfaceOutput s, float3 lightDir, half3 viewDir, float shadowAttenuation) {
				//how much the surface normal points towards the light
				...
				//calculate shadow color and mix light and shadow based on the light. Then taint it based on light color
